          ...
          <!-- <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="">Ajouter nouveau produits</a></li>
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                   <div class="col-3">
                    <div>
                      <i class="fs-1 bi bi-bag text-success"></i>
                    </div>
                    </div>
                    <div class="row">
                      <div class="col-9">
                    ...
                    <h6 class="text-muted font-weight-normal">Nombre de produits </h6>
                  </div>
                </div>
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                <div class="card">
                  ...
                  <div class="col-3">
                        <div id="icon-box">
                          ...
                          <i class="fs-1 bi bi-cash-coin text-success"></i>
                        </div>
                      </div>
                    <div class="row">
                      <div class="col-9">
              ...
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                 <div class="card">
                  <div class="card-body">
                    <div class="col-3">
                        <div class="icon">
                          <i class="fs-1 bi bi-basket-fill text-success"></i>
                        </div>
                      </div>
                    <div class="row">
                      <div class="col-9">
                    ...
                    <h6 class="text-muted font-weight-normal">Commandes total</h6>
                  </div>
                </div>                 
              </div>
              <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
