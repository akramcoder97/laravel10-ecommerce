            ...
            @if($items->count() > 0)
                            ...
                            <tbody>
                                @foreach($items as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->model->stock_status == 'instock')
                                                <a href="javascript:void(0)" onclick="moveToCart('{{$item->rowId}}')" class="icon">
                                                    <i class="fas fa-shopping-cart"></i>
                                                </a>
                                            @else
                ...
                <div class="row">
                    <div class="col-md-12 text-end">
                        <a href="javascript:void(0)" onclick="clearWishlist()">effacer la list</a>
                    </div>
                </div>
           @else    
           <div class="row-">
                <div class="col-md-12 text-center">
                    <h2>votre liste de favorie est vide!</h2>
                    <h5 class="mt-3">ajouter des elements maintenant?</h5>
