        ...
        <div class="container">
            <div class="row">
                                                ...
                                                <li>
                                                    <div class="form-check ps-0 custome-form-check">
                                                        <input class="checkbox_animated check-it" id="br{{$brand->id}}" name="brands"
                                                            ...
                                                            value="{{$brand->id}}" type="checkbox" onchange="filterByBrand(this)">
                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    <input class="checkbox_animated check-it" id="ct{{$category->id}}" name="categories"
                                                        type="checkbox" value="{{$category->id}}" @if(in_array($category->id,explode(',',$q_categories))) checked="checked" @endif
                ...
                <div class="category-product col-lg-9 col-12 ratio_30">
                    ...
                    {{ $products->withQueryString()->links('.pagination.default') }}     <!-- pour naviger entre les pages -->
                    <!-- {{ $products->links() }}    hadi par default -->
    ...
    <script>
       $(function(){
            $("#pagesize").on("change",function(){
                $("#size").val($("#pagesize option:selected").val()); // ma3naha ystoki value ta3 page size selected fel form li darha w yab3atha b request vers controller
                $("#frmFilter").submit();
            });
        ...
        function getCartWishlistCount()
        {
            $.ajax({
                type:'GET',
                url:'{{route('shop.cart.wihslist.count')}}',
                success:function(data){
                    if(data.status == 200)
                    {
